    ...
    (function (e, t) {
        ...
        function y(e, t, r) {
            var n = /\.css$/i.test(m(e)),
                i = c(n ? "link" : "script", "", s(n ? { href: e, rel: "stylesheet" } : { src: e }, r));
            return (
                i.readyState
        ...
        function q(e, t) {
            ...
            d(n, Z),
                r[0]
                    ? ((rt.style.display = I > 1 ? "" : "none"), (nt.style.display = Q > r[0] ? "none" : ""), (et.innerHTML = r[1]), d(n, et))
                    : ((n.innerHTML = '<p class="' + J + "-results-" + i + '">' + K[i].replace("%s%", k(j)) + "</p>"), (nt.style.display = "none")),
                d(n, tt),
                d(W, X),
                b(),
                p(Y);
        }
        function T(query, startIndex) {
                ...
                let promise = new Promise((resolve) => {
                    y(
                        ...
                        function () {
                            f(P, J + "-loading");
                            n(_[word]) || (_[word] = {});
                            let resultHTML = et.innerHTML;
                            _[word][startIndex] = [et.children.length, resultHTML];
                            resolve();
                        }
                    );
                });
            ...
            // Wait for all search promises to complete before displaying the results
            Promise.all(searchPromises).then(() => {
                q(words.join(' '), startIndex);
            });
        }
        function N(e) {
            e && e.preventDefault();
        ...
        var L = e.q2o,
            ...
            R = {
                ...
                target: 0,
                chunk: 50,
                text: { title: "Search results for query <em>%s%</em>", loading: "Searching&hellip;", previous: "Previous", next: "Next", empty: "No results for query <em>%s%</em>.", end: "No more results for query <em>%s%</em>." },
        ...
        if (P) {
            ...
            l(e, "scroll", b),
                ...
                (e["_" + B] = function (e) {
                                ...
                                if (((str = ""), t)) {
                                    if (b) {
                                        ...
                                        b === !0 && (b = 60),
                                            ...
                                            (str += o
                                                ? '<img class="lazyload" alt="" src="' + e.media$thumbnail.url.replace(/\/s\d+(\-c)?\//g, "/" + b + "/") + '" style="display:block;width:' + r + ";height:" + n + ';">'
                                                : '<span class="img lazyload" style="display:block;width:' + r + ";height:" + n + ';">'),
                                            (str += "</p>");
                                    }
                    ...
                    x() && y(g("5432787597195842010") + h(s(D.query, { callback: "_" + B + "_", "max-results": 21, orderby: "updated" })) + "&q=" + r(j)), v(X, "load", [e, j, I]);
                }),
                (e["_" + B + "_"] = function (e) {
                    e = e.feed || {};
                    var t = e.entry || [];
